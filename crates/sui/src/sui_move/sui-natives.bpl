...
procedure {:inline 1} $2_dynamic_field_borrow_mut{{S}}(p: $Mutation ($2_object_UID), k: {{K}})
returns (dst: $Mutation ({{V}}), p': $Mutation ($2_object_UID));
// TODO(mengxu): need to complete this
